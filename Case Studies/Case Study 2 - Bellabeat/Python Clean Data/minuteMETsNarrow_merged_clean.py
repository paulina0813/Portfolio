...
df = pd.read_csv(r'/Users/Paulina_1/Documents/Data Analysis Certification Google/Case Studies/Case Study 2 - Bellabeat/Data/Fitabase Data 4.12.16-5.12.16/minuteMETsNarrow_merged.csv')
print(df)
...
columns_to_strip = ['id', 'activity_minute', 'mets', 'formatted_activity_minute', 'activity_day', 'activity_time_minute', 'weekday', 'id_length']
...
#df_cleaned.to_csv('/Users/Paulina_1/Documents/Data Analysis Certification Google/Case Studies/Case Study 2 - Bellabeat/Data/Clean Data/minuteMETsNarrow_merged_clean.csv', index=False)